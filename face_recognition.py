...
class Face_Recognition:
    def __init__(self, root):
        ...
        title_lbl=Label(self.root, text="FACEIPHY-Simplifying Lives",font=("times new roman",35,"bold"), bg="white",fg="dark blue")
        ...
        b1_1=Button(self.root,text="SCAN WITH FaceiPhi",cursor="hand2", command=self.face_recog,font=("times new roman",15,"bold"), bg="light blue",fg="dark blue")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for(x,y,w,h) in features:
                ...
                conn=mysql.connector.connect(host="localhost",username="root",password="Useme@123",database="face_recognizer")
